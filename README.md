...
GeoCat BV has maintained this series as needed to support geoserver and core-geonetwork project:

- 2.4.x: Migrate to ImageN
...
5. Push and tag the change:
   ...
   ```bash
   git push
   git tag -a release/2.3.5 -m "Release 2.3.5"
